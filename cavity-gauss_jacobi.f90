...
double precision, dimension (:), allocatable :: diag, updiag, lowdiag, sdiag, ndiag, x
...
allocate (diag(nx*ny), updiag(nx*ny), lowdiag(nx*ny), ndiag(nx*ny), sdiag(nx*ny), x(nx*ny))
...
deallocate (diag, updiag, lowdiag, ndiag, sdiag, x)
